package io.github.chengmboy.cloudrs.gateway.handler;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.github.chengmboy.cloudrs.common.constants.CommonConstant;
import io.github.chengmboy.cloudrs.common.exception.CloudrsDeniedException;
...
public class VoleAccessDeniedHandler extends OAuth2AccessDeniedHandler {
    ...
    public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException authException) throws IOException, ServletException {
        ...
        Response<String> result = Response.error(new CloudrsDeniedException("授权失败，禁止访问"));
